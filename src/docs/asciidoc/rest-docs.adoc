...
==== 성공
===== Request
include::{snippets}/투표 생성 성공/http-request.adoc[]
===== Request Headers
include::{snippets}/투표 생성 성공/request-headers.adoc[]
===== Request Fields
include::{snippets}/투표 생성 성공/request-fields.adoc[]
===== Response
include::{snippets}/투표 생성 성공/http-response.adoc[]

==== 실패 - 비로그인 사용자가 시도한 경우
===== Request
include::{snippets}/투표 생성 실패 - 비로그인 사용자가 시도한 경우/http-request.adoc[]
===== Request Headers
include::{snippets}/투표 생성 실패 - 비로그인 사용자가 시도한 경우/request-headers.adoc[]
===== Request Fields
include::{snippets}/투표 생성 실패 - 비로그인 사용자가 시도한 경우/request-fields.adoc[]
===== Response
include::{snippets}/투표 생성 실패 - 비로그인 사용자가 시도한 경우/http-response.adoc[]
===== Response Fields
include::{snippets}/투표 생성 실패 - 비로그인 사용자가 시도한 경우/response-fields.adoc[]

==== 실패 - 투표자 id 없는 경우
===== Request
include::{snippets}/투표 생성 실패 - 투표자 id 없는 경우/http-request.adoc[]
===== Request Headers
include::{snippets}/투표 생성 실패 - 투표자 id 없는 경우/request-headers.adoc[]
===== Request Fields
include::{snippets}/투표 생성 실패 - 투표자 id 없는 경우/request-fields.adoc[]
===== Response
include::{snippets}/투표 생성 실패 - 투표자 id 없는 경우/http-response.adoc[]
===== Response Fields
include::{snippets}/투표 생성 실패 - 투표자 id 없는 경우/response-fields.adoc[]

==== 실패 - 투표하는 엔티티의 id 없는 경우
===== Request
include::{snippets}/투표 생성 실패 - 투표하는 엔티티의 id 없는 경우/http-request.adoc[]
===== Request Headers
include::{snippets}/투표 생성 실패 - 투표하는 엔티티의 id 없는 경우/request-headers.adoc[]
===== Request Fields
include::{snippets}/투표 생성 실패 - 투표하는 엔티티의 id 없는 경우/request-fields.adoc[]
===== Response
include::{snippets}/투표 생성 실패 - 투표하는 엔티티의 id 없는 경우/http-response.adoc[]
===== Response Fields
include::{snippets}/투표 생성 실패 - 투표하는 엔티티의 id 없는 경우/response-fields.adoc[]

==== 실패 - 이미 투표한 경우
===== Request
include::{snippets}/투표 생성 실패 - 이미 투표한 경우/http-request.adoc[]
===== Request Headers
include::{snippets}/투표 생성 실패 - 이미 투표한 경우/request-headers.adoc[]
===== Request Fields
include::{snippets}/투표 생성 실패 - 이미 투표한 경우/request-fields.adoc[]
===== Response
include::{snippets}/투표 생성 실패 - 이미 투표한 경우/http-response.adoc[]
===== Response Fields
include::{snippets}/투표 생성 실패 - 이미 투표한 경우/response-fields.adoc[]